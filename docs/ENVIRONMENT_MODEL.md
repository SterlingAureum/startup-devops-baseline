...
Only `aws-dev` exists in the repository's deployed baseline at v0.9.0. The
aws-test and aws-prod rows define the accepted target model; their manifests
and Terraform environments are delivered in later v0.9 increments.
...
At v0.9.0, the root Application and every internal-repository child
