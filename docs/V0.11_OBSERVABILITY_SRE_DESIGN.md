...
the Downward API. Loki and Alloy remain the v0.11.6.1.1 successor boundary;
tracing remains deferred to v0.11.6.2.
...
| v0.11.6 | Centralized logs and minimal extensible tracing path; v0.11.6.0 defines the architecture and v0.11.6.1.0 implements bounded demo-api JSON logging plus canonical release-identity projection |
