...
| v0.11.6 | Centralized logs and minimal extensible tracing path; v0.11.6.0 defines per-environment, schema, cardinality, collector, backend, security, cost, and acceptance contracts without deploying runtime components |
