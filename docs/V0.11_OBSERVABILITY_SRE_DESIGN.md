...
24-hour retention. Kubernetes Events and the Grafana Loki data source remain
v0.11.6.1.2 scope; tracing remains deferred to v0.11.6.2.
...
| v0.11.6 | Centralized logs and minimal extensible tracing path; v0.11.6.0 defines the architecture, v0.11.6.1.0 implements bounded demo-api JSON logging, and v0.11.6.1.1 adds private local Loki plus Alloy Pod-log collection |
