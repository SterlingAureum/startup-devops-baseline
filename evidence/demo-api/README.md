...
v0.10.4 adds the durable, self-contained aws-dev Qualification Bundle used by
the automated orchestration path:
...
immutable release, and a deterministic aws-dev deployment-scope hash. The
