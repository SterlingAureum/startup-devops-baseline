...
output "github_actions_runtime_role_arn" {
  description = "IAM role ARN configured as AWS_RUNTIME_ROLE_ARN in aws-test-runtime."
  value       = try(module.github_actions_runtime_identity[0].role_arn, null)
}

output "github_actions_runtime_oidc_subject" {
  description = "Exact GitHub OIDC subject accepted by the aws-test runtime role."
