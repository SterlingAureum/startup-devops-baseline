...
spec=importlib.util.spec_from_file_location('teardown',h.ROOT/'scripts/execute-v0.11.9.3.6.7.6-aws-test-teardown.py')
...
class TeardownTests(unittest.TestCase):
    ...
    def test_final_saved_plan_once_and_hash_tamper_stops_before_apply(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            proof={'stage':'final','main':'a'*40,'human_reviewed':True,'inputs_sha256':h.p.digest(inputs),'state_sha256':'before',
