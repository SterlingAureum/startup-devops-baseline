...
echo "==> Validating v0.11.9.3.3 reviewed main integration"
...
echo "==> Validating v0.11.9.3.6.1 aws-dev live-rehearsal create executor"
...
echo "==> Validating v0.11.9.3.6.4.2 aws-dev monitoring convergence execution evidence"
"${ROOT_DIR}/scripts/validate-v0.11.9.3.6.4.2-aws-dev-monitoring-convergence-execution.sh"
...
echo "==> Validating v0.11.9.3.6.5.2 aws-dev runtime qualification execution evidence"
"${ROOT_DIR}/scripts/validate-v0.11.9.3.6.5.2-aws-dev-runtime-qualification-execution.sh"
...
"${ROOT_DIR}/scripts/validate-v0.11.9.3.6.6.2-historical-checkpoint-ci-decoupling.sh"
...
echo "==> Validating v0.11.9.3.6.6.5.2 aws-dev teardown execution evidence"
"${ROOT_DIR}/scripts/validate-v0.11.9.3.6.6.5.2-aws-dev-teardown-execution-evidence.sh"
...
echo "==> Validating v0.11.9.3.6.7.2 guarded aws-test Terraform plan executor"
"${ROOT_DIR}/scripts/validate-v0.11.9.3.6.7.2-aws-test-terraform-plan-executor.sh"
...
echo "==> Validating v0.11.9.3.6.7.3.1 aws-test state-classification repair"
"${ROOT_DIR}/scripts/validate-v0.11.9.3.6.7.3.1-aws-test-state-classification-repair.sh"
...
echo "==> Validating v0.11.9.3.6.7.4.1 aws-test GitOps bootstrap execution evidence"
"${ROOT_DIR}/scripts/validate-v0.11.9.3.6.7.4.1-aws-test-gitops-bootstrap-execution-evidence.sh"
...
echo "==> Validating v0.11.9.3.6.7.5.1 aws-test Root capacity and cost"
"${ROOT_DIR}/scripts/validate-v0.11.9.3.6.7.5.1-aws-test-root-capacity-cost.sh"

echo "==> Validating v0.11.9.3.6.7.5.2 immutable aws-test Root deployment"
"${ROOT_DIR}/scripts/validate-v0.11.9.3.6.7.5.2-aws-test-immutable-root-deployment.sh"
...
echo "==> Validating v0.11.9.3.6.7.7.5 offline cleanup adapters"
"${ROOT_DIR}/scripts/validate-v0.11.9.3.6.7.7.5-offline-cleanup-adapters.sh"
