...
def validate_repository() -> None:
    ...
    chart = require_markers(
        ...
        (
            "version: 0.8.2" if canary_endpoint_repair_successor else ("version: 0.8.1" if slo_analysis_repair_successor else ("version: 0.8.0" if slo_rollout_successor else ("version: 0.7.0" if tracing_successor else ("version: 0.6.0" if structured_logging_successor else "version: 0.5.1")))),
