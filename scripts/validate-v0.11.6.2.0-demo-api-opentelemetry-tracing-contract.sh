...
require(("version: 0.8.1" if slo_analysis_repair_successor else ("version: 0.8.0" if slo_rollout_successor else "version: 0.7.0")) in chart and 'appVersion: "0.5.0"' in chart, "demo-api Chart identity not advanced")
